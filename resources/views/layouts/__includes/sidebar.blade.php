      ...
      <div class="menu-item has-sub">
        ...
        <div class="menu-item has-sub">
          <a href="javascript:;" class="menu-link">
            ...
            <div class="menu-submenu">
              <div class="menu-item">
                <a href="index.html" class="menu-link"><div class="menu-text"> Account Informations </div></a>
              </div>
              <div class="menu-item">
                <a href="index_v3.html" class="menu-link"><div class="menu-text"> Change Password </div></a>
              </div>
          ...
          <div class="menu-header"> Administratives </div>
          <div class="menu-item has-sub">
            <a href="javascript:;" class="menu-link">
              <div class="menu-icon">
              ...
              <div class="menu-submenu">
                <div class="menu-item"><a href="index.html" class="menu-link"><div class="menu-text"> Customizations </div></a></div>
                <div class="menu-item"><a href="index_v3.html" class="menu-link"><div class="menu-text"> Optimizations </div></a></div>
                <div class="menu-item"><a href="index_v3.html" class="menu-link"><div class="menu-text"> Settings </div></a></div>
              </div>
            </div>
            <div class="menu-item has-sub">
              <a href="javascript:;" class="menu-link">
                <div class="menu-icon">
                  <i class="fa fa-user-gear"></i>							</div>
                  <div class="menu-text"> Managements </div>
                  <div class="menu-caret"></div>
                </a>
                <div class="menu-submenu">
                  <div class="menu-item"><a href="index_v3.html" class="menu-link"><div class="menu-text"> Permissions </div></a></div>
                  <div class="menu-item"><a href="index_v3.html" class="menu-link"><div class="menu-text"> Roles </div></a></div>
                  <div class="menu-item"><a href="index.html" class="menu-link"><div class="menu-text"> Users </div></a></div>
                </div>
              </div>
