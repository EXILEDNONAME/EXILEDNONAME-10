...
<div class="panel panel-inverse">
  ...
  <div class="panel-body">
    <table id="exilednoname_table" class="table table-hover align-middle">
      <thead>
        <tr>
          <th width="1%"> </th>
    ...
    var table = $('#exilednoname_table').DataTable({
      ...
      columns: [
        ...
        @if (empty($active) || $active == 'true')
        {
          ...
          render: function ( data, type, row ) {
            if ( data == 0 ) { return '<a href="javascript:void(0);" class="text-decoration: none" id="active" title="Switch To Active" data-id="' + row.id + '"><label class="badge bg-dark"> No </label></a>'; }
